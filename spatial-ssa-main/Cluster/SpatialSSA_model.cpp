...
void Model::reset(){
    ...
    // Suitable for small cell of radius 0.282, 50000 particles per area, added 2000 particles.
    // make_particle_spot(585, 0.07, 120, 0);
    // make_particle_spot(2139, 0.07, 120, 0);
