...
#SBATCH --job-name="Yeast_polarization_high_GAP_activity"
...
chmod u+x ./SpatialSSA_setup_1_GAP_activity_repeat
srun ./SpatialSSA_setup_1_GAP_activity_repeat ${dirname}
