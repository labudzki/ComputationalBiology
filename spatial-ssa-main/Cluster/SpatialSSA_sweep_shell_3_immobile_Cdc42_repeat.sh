...
#SBATCH --job-name="Yeast_polarization_immobile_Cdc42"
...
# sweep_file="sweep_setups_wildtype.txt"
...
chmod u+x ./SpatialSSA_setup_3_immobile_Cdc42_repeat
srun ./SpatialSSA_setup_3_immobile_Cdc42_repeat ${dirname}
