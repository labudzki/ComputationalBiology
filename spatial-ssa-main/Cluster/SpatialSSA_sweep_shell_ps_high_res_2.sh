...
#SBATCH --job-name="Yeast_polarization_sweep_phase_seperation_high_res"
...
sweep_file="sweep_setups_ps_high_res_2.txt"
...
chmod u+x ./SpatialSSA_setup_ps_correct 
srun ./SpatialSSA_setup_ps_correct ${dirname} ${sweep_setup}