...
#SBATCH --job-name="Particle_phase_seperation"
...
sweep_file="sweep_setups_ps_particle_zoom.txt"
...
chmod u+x ./SpatialSSA_setup_ps_particle
srun ./SpatialSSA_setup_ps_particle ${dirname} ${sweep_setup}