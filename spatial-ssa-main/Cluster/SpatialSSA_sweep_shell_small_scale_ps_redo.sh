...
#SBATCH --job-name="Particle_phase_seperation_small_scale"
...
sweep_file="sweep_setups_small_scale_ps_redo.txt"
...
chmod u+x ./SpatialSSA_setup_small_scale_ps
srun ./SpatialSSA_setup_small_scale_ps ${dirname} ${sweep_setup}